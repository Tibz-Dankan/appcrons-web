...
import { TAdminSearchInput } from "@/types/admin";

interface SearchUsersProps {
  onSuccess: (apps: any[]) => void;
  onQueryValue: (hasQueryValue: boolean) => void;
}

export const SearchUsers: React.FC<SearchUsersProps> = (props) => {
  ...
  const { isPending, mutate } = useMutation({
    mutationFn: new AdminService().search,
  ...
  const initialValues: TAdminSearchInput = {
    query: "",
